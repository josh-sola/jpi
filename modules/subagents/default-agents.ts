...
export const DEFAULT_AGENTS: Map<string, AgentConfig> = new Map([
  [
    "general-purpose",
    {
      ...
      description:
        "General-purpose agent for complex research, code search, analysis, and scoped implementation.",
...
When finished, return a concise report covering what you changed or found, the checks you ran, and any unresolved limitation. Your report goes to the caller, not directly to the user.`,
  ...
  [
    "explore",
    {
      ...
      displayName: "explore",
      description:
        "Fast read-only specialist for locating files, tracing code, and answering codebase questions.",
...
Return findings as a regular message. Cite absolute file paths and relevant line numbers. Do not create a report file.`,
  ...
  [
    "plan",
    {
      ...
      displayName: "plan",
      description:
        "Read-only software architect for implementation plans, sequencing, dependencies, and trade-offs.",
      builtinToolNames: READ_ONLY_TOOLS,
      extensions: true,
      skills: true,
