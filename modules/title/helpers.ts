...
export const WAITING_INDICATOR = "⧗";
export const INPUT_INDICATOR = "‼";
...
export function sessionIndicator(sessionName: unknown, worktreeName: unknown, cwd: string): string {
  return (
    sanitizeTitlePart(sessionName) ||
