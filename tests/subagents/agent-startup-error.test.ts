...
vi.mock("../../modules/subagents/worktree.ts", async () => {
  const actual = await vi.importActual<typeof import("../../modules/subagents/worktree.ts")>(
    "../../modules/subagents/worktree.ts",
  );
