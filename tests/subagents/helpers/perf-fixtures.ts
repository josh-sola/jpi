 ...
 *
 * Three consumers share this: the benchmarks (`tests/perf/*.bench.ts`), the
 * invariant guards (`tests/perf/*.perf.test.ts`), and the A/B harness
 * (`tests/perf/ab.mjs`), which copies this file into a worktree of an older
 ...
 * importing anything from `modules/subagents/`. A fixture that reached into production types
