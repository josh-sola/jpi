// modules/subagents/model-scope.ts had no test file. Its `error` verdict was reachable only
...
import type { ModelRegistryRef } from "../../modules/subagents/enabled-models.ts";
import {
  checkModelScope,
  isScopeModelsEnabled,
  setScopeModelsEnabled,
} from "../../modules/subagents/model-scope.ts";
