...
import type { EventBus } from "../../modules/subagents/cross-extension-rpc.ts";
import {
  FLEET_CONSUMER_READY_CHANNEL,
  FLEET_PROVIDER_CHANNEL,
  type FleetProviderPayload,
  wireFleetFooterProvider,
} from "../../modules/subagents/fleet-footer-bridge.ts";
import type { FleetConsumer, FleetList } from "../../modules/subagents/ui/fleet-list.ts";
