...
import { buildAgentPrompt } from "../../modules/subagents/prompts.ts";
import type { AgentConfig, EnvInfo } from "../../modules/subagents/types.ts";
...
describe("buildAgentPrompt", () => {
  ...
  it("general-purpose uses append mode (parent twin)", () => {
    ...
    // general-purpose has a non-empty systemPrompt, so it gets an <agent_instructions> section
    expect(prompt).toContain("<agent_instructions>");
    expect(prompt).toContain("general-purpose subagent for Pi");
  });
